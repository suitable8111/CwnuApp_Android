...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        LocalBroadcastManager.getInstance(this)
                .sendBroadcast(new Intent(QuickstartPerferences.REGISTRATION_GENERATING));
        ...
        Intent registrationComplete = new Intent(QuickstartPerferences.REGISTRATION_COMPLETE);
