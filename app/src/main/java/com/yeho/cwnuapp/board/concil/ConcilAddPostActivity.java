...
public class ConcilAddPostActivity extends Activity implements View.OnClickListener {
    ...
    private class PostThread extends AsyncTask<String , Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                switch (params[0]){
                    case "Upload" :
                        url = "http://cinavro12.cafe24.com/cwnu/board_concil/cwnu_upload_post.php";
                        ...
                        break;
                    case "Update" :
                        url = "http://cinavro12.cafe24.com/cwnu/board_concil/cwnu_update_post.php";
                        ...
                        break;
                    case "Comment" :
                        url = "http://cinavro12.cafe24.com/cwnu/board_concil/comment_concil/cwnu_upload_comment.php";
                        ...
                        break;
                    case "UpdateComment" :
                        url = "http://cinavro12.cafe24.com/cwnu/board_concil/comment_concil/cwnu_update_comment.php";
                        //nameValue.add(new BasicNameValuePair("name", params[1]));
