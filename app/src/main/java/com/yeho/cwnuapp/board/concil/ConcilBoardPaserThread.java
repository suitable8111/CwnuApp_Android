 ...
 */
public class ConcilBoardPaserThread extends Thread {
    ...
    public ConcilBoardPaserThread(Handler handler, String category ){
    ...
    public ConcilBoardPaserThread(Handler handler, String category, String commentBoradId){
        this.handler = handler;
    ...
    public void run() {
        ...
        try {
            ...
            if (category.equals("ALL")) {
                url = new URL("http://cinavro12.cafe24.com/cwnu/board_concil/cwnu_board_xml.php");
                ...
                url = new URL("http://cinavro12.cafe24.com/cwnu/board_concil/cwnu_board_me_xml.php?kakaoid="+kakaoId);
            }else if (category.equals("COMMENT")){
                url = new URL("http://cinavro12.cafe24.com/cwnu/board_concil/comment_concil/cwnu_board_comment_xml.php?boardid="+commentBoradId);
            } else if (category.equals("SEARCH")){
                url = new URL("http://cinavro12.cafe24.com/cwnu/board_concil/cwnu_board_search_xml.php?searchname="+searchingText+"&searchtitle="+searchingText+"&searchcontext="+searchingText);
            }
