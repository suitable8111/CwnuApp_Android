...
public class BoardAdapter extends BaseAdapter {
    ...
    public BoardAdapter(Context conA,ArrayList<HashMap<String,String>> allAry){
...
//                if (allAry.get(position).get("commentcount").equals("null")) {
//                    holder.tvCommnetCount.setText("댓글 : +0");
//                } else {
//                    holder.tvCommnetCount.setText("댓글 : +" + allAry.get(position).get("commentcount"));
//                }
...
//                }
                ...
                holder.btnDelete.setTag(R.id.post_delete_pos, position);
                ...
                holder.btnUpdate.setTag(R.id.post_update_title, allAry.get(position).get("title"));
                holder.btnUpdate.setTag(R.id.post_update_context, allAry.get(position).get("context"));
...
//    }
    ...
    private class DeletePost extends AsyncTask<Void, Void, String> {
        ...
        protected String url = "http://cinavro12.cafe24.com/cwnu/board/cwnu_delete_post.php";
