...
import com.yeho.cwnuapp.board.free.BoardAdapter;
...
public class ConcilBoardActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    //리스트 뷰 커스텀 어댑터
    private ConcilBoardAdapter boardAdapter        = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTextView.setText("총학생회 게시판");
        ...
        boardAdapter = new ConcilBoardAdapter(this, allAry);
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                switch (actionId) {
                    case EditorInfo.IME_ACTION_SEARCH:
                        ...
                        ConcilBoardPaserThread searchThread = new ConcilBoardPaserThread(handler, "SEARCH");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intentBD = new Intent(this, ConcilBoardDetailActivity.class);
    ...
    private void startParsing(){
        ...
        mProgressDialog = ProgressDialog.show(ConcilBoardActivity.this,"", "잠시만 기다려 주세요.",true);
        handler = new Handler(){
            @Override
            public void handleMessage(Message msg) {
        ...
        thread = new ConcilBoardPaserThread(handler, "ALL");
        thread.start();
    }
    ...
    private class UploadViewCount extends AsyncTask<Void, Void, String> {
        ...
        protected String url = "http://cinavro12.cafe24.com/cwnu/board_concil/cwnu_upload_view_count.php";
