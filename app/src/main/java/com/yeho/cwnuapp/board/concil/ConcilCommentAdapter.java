 ...
 */
public class ConcilCommentAdapter extends BaseAdapter {
    ...
    public ConcilCommentAdapter(Context conA,ArrayList<HashMap<String,String>> allAry, String boardId){
...
//
            ///////////////////////////////////////////////////////////////
            holder.btnDelete.setTag(allAry.get(position).get("id"));
            holder.btnDelete.setTag(R.id.comment_concil_delete_pos, position);
            holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final String vIdTag = (String) v.getTag();
                    final int vPos = (int) v.getTag(R.id.comment_concil_delete_pos);
            ...
            holder.btnUpdate.setTag(allAry.get(position).get("id"));
            holder.btnUpdate.setTag(R.id.comment_concil_update_name, allAry.get(position).get("title"));
            holder.btnUpdate.setTag(R.id.comment_concil_update_context, allAry.get(position).get("context"));

            holder.btnUpdate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final String vIdTag = (String) v.getTag();
                    final String vContextTag = (String) v.getTag(R.id.comment_concil_update_context);
                    final String vNameTag = (String) v.getTag(R.id.comment_concil_update_name);
...
//    }
    ...
    private class DeleteComment extends AsyncTask<Void, Void, String> {
        protected String url = "http://cinavro12.cafe24.com/cwnu/board_concil/comment_concil/cwnu_delete_comment.php";
